...
# Paths to the base64 files
logo_path = '/Users/saeed/Desktop/score\'n---showcase-skills (2)/logo_b64.txt'
circle_path = '/Users/saeed/Desktop/score\'n---showcase-skills (2)/circle_b64.txt'
...
function doPost(e) {{
  try {{
    ...
    // Columns: Date, Name, Email, Region, School, Position, Age, Height, Foot, Heatmap, Status
    sheet.appendRow([
      new Date(),
      data.name,
      data.email,
    ...
    // We use 'cid:cardImage' to reference the attached blob inline
    const emailBody = `
...
// RUN THIS FUNCTION ONCE TO AUTHORIZE GMAIL
function testAuth() {{
...
print("Successfully updated google_apps_script.js with PNG base64 images.")
